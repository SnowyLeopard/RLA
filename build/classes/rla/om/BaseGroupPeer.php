...
abstract class BaseGroupPeer {
	...
	const CATEGORY_ID = 'groups.CATEGORY_ID';

	/** the column name for the GROUP_TYPE field */
	const GROUP_TYPE = 'groups.GROUP_TYPE';

	/** The enumerated values for the GROUP_TYPE field */
	const GROUP_TYPE_GROUP = 'group';
	const GROUP_TYPE_CHAIN = 'chain';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'CategoryId', 'GroupType', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'categoryId', 'groupType', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DESCRIPTION, self::CATEGORY_ID, self::GROUP_TYPE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DESCRIPTION', 'CATEGORY_ID', 'GROUP_TYPE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'category_id', 'group_type', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'CategoryId' => 3, 'GroupType' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'categoryId' => 3, 'groupType' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DESCRIPTION => 2, self::CATEGORY_ID => 3, self::GROUP_TYPE => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, 'CATEGORY_ID' => 3, 'GROUP_TYPE' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'category_id' => 3, 'group_type' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	protected static $enumValueSets = array(
		self::GROUP_TYPE => array(
			GroupPeer::GROUP_TYPE_GROUP,
			GroupPeer::GROUP_TYPE_CHAIN,
		),
	);
	...
	{
	  return GroupPeer::$enumValueSets;
	}
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(GroupPeer::CATEGORY_ID);
			$criteria->addSelectColumn(GroupPeer::GROUP_TYPE);
		} else {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(GroupPeer::CATEGORY_ID);
			$value = $criteria->remove(GroupPeer::CATEGORY_ID);
			if ($value) {
				$selectCriteria->add(GroupPeer::CATEGORY_ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(GroupPeer::TABLE_NAME);
			}
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(GroupPeer::ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(GroupPeer::CATEGORY_ID, $value[1]));
				$criteria->addOr($criterion);
				// we can invalidate the cache for this single PK
				GroupPeer::removeInstanceFromPool($value);
			}
		}
	...
	public static function retrieveByPK($id, $category_id, PropelPDO $con = null) {
		$_instancePoolKey = serialize(array((string) $id, (string) $category_id));
 		if (null !== ($obj = GroupPeer::getInstanceFromPool($_instancePoolKey))) {
 			return $obj;
		}
		...
		$criteria->add(GroupPeer::ID, $id);
		$criteria->add(GroupPeer::CATEGORY_ID, $category_id);
