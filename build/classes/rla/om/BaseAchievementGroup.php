...
/**
 * Base class that represents a row from the 'achievement_group' table.
 *
 * 
 *
 * @package    propel.generator.rla.om
 */
abstract class BaseAchievementGroup extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AchievementGroupPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        AchievementGroupPeer
	 */
	 ...
	 * @return     AchievementGroup The current object (for fluent API support)
	 */
	public function setAchievementId($v)
	{
		...
		if ($this->achievement_id !== $v) {
			...
			$this->modifiedColumns[] = AchievementGroupPeer::ACHIEVEMENT_ID;
		}
	...
	public function setGroupId($v)
	{
		...
		if ($this->group_id !== $v) {
			$this->group_id = $v;
			$this->modifiedColumns[] = AchievementGroupPeer::GROUP_ID;
		}
	...
	public function setWeight($v)
	{
		...
		if ($this->weight !== $v) {
			$this->weight = $v;
			$this->modifiedColumns[] = AchievementGroupPeer::WEIGHT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->achievement_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 3; // 3 = AchievementGroupPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating AchievementGroup object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AchievementGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AchievementGroupQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AchievementGroupPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AchievementGroupPeer::ACHIEVEMENT_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ACHIEVEMENT_ID`';
		}
		if ($this->isColumnModified(AchievementGroupPeer::GROUP_ID)) {
			$modifiedColumns[':p' . $index++]  = '`GROUP_ID`';
		}
		if ($this->isColumnModified(AchievementGroupPeer::WEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`WEIGHT`';
		}

		$sql = sprintf(
			'INSERT INTO `achievement_group` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AchievementGroupPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AchievementGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AchievementGroup'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AchievementGroup'][serialize($this->getPrimaryKey())] = true;
		$keys = AchievementGroupPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getAchievementId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setAchievementId($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AchievementGroupPeer::ACHIEVEMENT_ID)) $criteria->add(AchievementGroupPeer::ACHIEVEMENT_ID, $this->achievement_id);
		if ($this->isColumnModified(AchievementGroupPeer::GROUP_ID)) $criteria->add(AchievementGroupPeer::GROUP_ID, $this->group_id);
		if ($this->isColumnModified(AchievementGroupPeer::WEIGHT)) $criteria->add(AchievementGroupPeer::WEIGHT, $this->weight);
	...
	{
		$criteria = new Criteria(AchievementGroupPeer::DATABASE_NAME);
		$criteria->add(AchievementGroupPeer::ACHIEVEMENT_ID, $this->achievement_id);
		$criteria->add(AchievementGroupPeer::GROUP_ID, $this->group_id);
	...
	{
		return (null === $this->getAchievementId()) && (null === $this->getGroupId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AchievementGroup (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AchievementGroup Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AchievementGroupPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AchievementGroupPeer();
		}
		return self::$peer;
	}
	...
	public function getAchievement(PropelPDO $con = null)
	{
		if ($this->aAchievement === null && ($this->achievement_id !== null)) {
			$this->aAchievement = AchievementQuery::create()
				->filterByAchievementGroup($this) // here
				->findOne($con);
			/* The following can be used additionally to
				...
				$this->aAchievement->addAchievementGroups($this);
			 */
		}
	...
	public function getGroup(PropelPDO $con = null)
	{
		if ($this->aGroup === null && ($this->group_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aGroup->addAchievementGroups($this);
			 */
		}
		return $this->aGroup;
	}
	...
	{
		return (string) $this->exportTo(AchievementGroupPeer::DEFAULT_STRING_FORMAT);
	}

} // BaseAchievementGroup
